...
- Before building or copying a test JAR, inspect enabled mod JAR metadata for mod ID `ae2`. If AE2 is absent, remove the instance and skip the launch; a dependency error caused by testing an AE2-free pack is invalid test evidence.
