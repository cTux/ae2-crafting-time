...
| Neo ECO AE Extension (`neoecoae`) | `1.20.1 Forge` | `>=20.3.0` | TTC profiling for C-series ECO crafting CPUs, including normal and FastPath dispatch. NeoEco 20.4.1 and 20.4.2 have an upstream AE2 mixin crash. |
