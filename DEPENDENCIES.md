...
| ExtendedAE-Plus (`extendedae_plus`) | `1.20.1 Forge`, `1.21.1 NeoForge` | `>=1.5.5` (Forge), `>=1.6.2` (NeoForge) | TTC profiling and UI coexistence with ExtendedAE-Plus crafting changes. |
