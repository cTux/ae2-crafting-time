...
| Client / Displays | [Compact crafting-status amounts](../crafting-status-amounts/spec.md) (`compactStatusAmounts`, planned in #438) | Restore native Available/Crafting/Scheduled lines and omit the compact legend; keep row TTC independent. Defaults on and remains effective with server profiling off. |
