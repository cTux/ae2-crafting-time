...
| Client / Displays | [Compact crafting amounts](../crafting-plan-amounts/spec.md) (`compactStatusAmounts`, #438 and #525) | Restore native amounts in Crafting Plan and Crafting Status and omit each compact legend; keep row TTC independent. Defaults on and remains effective with server profiling off. |
