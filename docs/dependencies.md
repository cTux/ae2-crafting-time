...
| Crazy AE2 Addons (`crazyae2addons`; optional) | `2.6.2` | Yes (`crazyae2addons-cpu`) | — | — | — | — | — | — | `1.20.1 Forge` | `>=2.6.2` | TTC profiling and Crafting Plan display with Crazy AE2 Addons CPU priorities. Provider dispatch uses a composable wrapper so Crazy AE2 Addons keeps its CPU bookkeeping. Its 2.6.2 CPU-list mixin currently overrides TTC ordering and hit testing; correction and exact-pack verification are tracked in #421. | [CF][crazyae2-cf] / [MR][crazyae2-mr] / [#76](https://github.com/cTux/ae2-crafting-time/issues/76) / [#316](https://github.com/cTux/ae2-crafting-time/issues/316) / [#421](https://github.com/cTux/ae2-crafting-time/issues/421) |
...
- **Crazy AE2 Addons `2.6.2` overrides Crafting Time's CPU-list TTC order on
  ...
  available, but CPU-list ordering and input compatibility are pending
