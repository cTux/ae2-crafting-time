...
| Applied Energistics 2 (required) | `15.4.10` | Yes (`craft-plan`, `no-space-status`) | `15.1.0` | Yes (`craft-plan`, `no-space-status`) | `19.2.17` | Yes (`craft-plan`, `no-space-status`) | `26.1.10-beta` | Yes (`craft-plan`, `no-space-status`) | — | See required dependencies | Required runtime / base AE2 crafting. | — |
...
| AE2 Lightning Tech (`ae2lt`; optional) | `2.1.0-beta.2-forge.1.20.1` | Yes (scenario) | — | — | `2.1.0-beta.2` | Yes (`lightningtech-cpu`) | `1.0.1alpha-26.1.2neoforge` | Yes (`lightningtech-cpu`) | `1.20.1 Forge`, `1.21.1 NeoForge` | `>=2.1.0-beta.2` | TTC profiling for Tianshu time-wheel crafting CPUs. | [CF][ae2lt-cf] / [MR][ae2lt-mr] / [#72](https://github.com/cTux/ae2-crafting-time/issues/72) |
