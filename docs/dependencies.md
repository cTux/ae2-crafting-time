...
| Crazy AE2 Addons (`crazyae2addons`; optional) | `2.6.2` | Yes (`crazyae2addons-cpu`) | — | — | — | — | — | — | `1.20.1 Forge` | `>=2.6.2` | TTC profiling and Crafting Plan display with Crazy AE2 Addons CPU priorities. Provider dispatch uses a composable wrapper so Crazy AE2 Addons keeps its CPU bookkeeping. | [CF][crazyae2-cf] / [MR][crazyae2-mr] / [#76](https://github.com/cTux/ae2-crafting-time/issues/76) / [#316](https://github.com/cTux/ae2-crafting-time/issues/316) |
