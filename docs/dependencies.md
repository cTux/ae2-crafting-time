...
| GuideME (`guideme`; optional) | — | — | — | — | `21.1.17` | Yes (guide book) | `26.1.10-alpha` | Yes (guide book) | `1.21.1 NeoForge`, `26.1.2 NeoForge` | 1.21.1: `>=21.1.0`; 26.1.2: `>=26.1.10-alpha` | Craftable bilingual in-game guide and first-estimate chapter. Without GuideME, the mod loads without the guide recipe. | [MR](https://modrinth.com/mod/guideme) / [#144](https://github.com/cTux/ae2-crafting-time/issues/144) |
