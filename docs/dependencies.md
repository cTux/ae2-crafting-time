...
| --- | --- |
| `1.20.1 Forge` | Minecraft `[1.20.1,1.21)`, Forge `[47.1.3,)`, Applied Energistics 2 `[15.0.10,16.0.0)`; GuideME `[20.1.15,20.2.0)` is optional for the in-game guide |
