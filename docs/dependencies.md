...
Fabric has a seven-case compatible suite; NeoForge 1.21.1 has a 21-case compatible
suite. NeoForge 26.1.2 has no automated UI suite yet.
...
| Applied Energistics 2 (required) | `15.4.10` | Yes (`craft-plan`, `no-space-status`) | `15.1.0` | Yes (`craft-plan`, `no-space-status`) | `19.2.17` | Yes (`craft-plan`, `no-space-status`) | `26.1.10-beta` | No | — | See required dependencies | Required runtime / base AE2 crafting. | — |
...
| AdvancedAE (`advanced_ae`; optional) | `1.3.6-1.20.1` | Yes (scenario) | — | — | `1.6.12-1.21.1` | Yes (`advancedae-cpu`) | `26.1.7` | No | `1.21.1 NeoForge`, `26.1.2 NeoForge` | 1.21.1: `>=1.6.11`; 26.1.2: `>=26.1.7` | TTC profiling for AdvancedAE crafting CPUs, including the Quantum Computer. | [CF][advancedae-cf] / [MR][advancedae-mr] / [#67](https://github.com/cTux/ae2-crafting-time/issues/67) |
...
| AE2 Lightning Tech (`ae2lt`; optional) | `2.1.0-beta.2-forge.1.20.1` | Yes (scenario) | — | — | `2.1.0-beta.2` | Yes (`lightningtech-cpu`) | `1.0.1alpha-26.1.2neoforge` | No | `1.20.1 Forge`, `1.21.1 NeoForge` | `>=2.1.0-beta.2` | TTC profiling for Tianshu time-wheel crafting CPUs. | [CF][ae2lt-cf] / [MR][ae2lt-mr] / [#72](https://github.com/cTux/ae2-crafting-time/issues/72) |
...
| ExtendedAE (optional) | `1.20-1.4.18-forge` | Yes (scenario) | `1.20-1.0.2-fabric` | Yes (`extendedae-cpu`) | `1.21-2.2.35-neoforge` | Yes (`extendedae-cpu`) | `26.1-1.0.3-neoforge` | No | — | — | Assembler/provider integration through AE2 UI and execution paths; Forge and Fabric drivers available. | [CF][extendedae-cf] / [#73](https://github.com/cTux/ae2-crafting-time/issues/73) |
...
| BM Addon (`bmaddon`; optional) | `1.0.4` | Yes (`bmaddon-cpu`) | — | — | `BMAddon1.21.1-beta1` | Yes (`bmaddon-cpu`) | `beta3` | No | `1.20.1 Forge`, `1.21.1 NeoForge`, `26.1.2 NeoForge` | Forge: `>=1.0.4`; 1.21.1: `>=1.21.1-beta1`; 26.1.2: `>=1.0.2` | TTC profiling and Crafting Plan display for crafts handled by the Blood Assembler. | [CF][bmaddon-cf] / [MR][bmaddon-mr] / [#75](https://github.com/cTux/ae2-crafting-time/issues/75) |
...
| AE2 Wireless Terminals (`ae2wtlib`; optional) | `15.3.3-forge` | Yes (`ae2wtlib-terminal`) | `15.2.1-fabric` | Yes (`ae2wtlib-terminal`) | `19.5.1` | Yes (`ae2wtlib-terminal`) | `26.1.1-beta` | No | All supported targets | 1.20.1 Forge: `>=15.3.3`; Fabric: `>=15.2.1`; 1.21.1: `>=19.5.1`; 26.1.2: `>=26.1.1-beta` | One-item TTC in craftable entries of its wireless crafting terminal. Crafting still uses AE2's normal CPU detection and Crafting Plan. | [CF][wireless-cf] / [MR][wireless-mr] / [#78](https://github.com/cTux/ae2-crafting-time/issues/78) |
...
| OMNI Cells (`ae2omnicells`; optional) | `1.1.6-1.20.1-forge` | Yes (`omnicells-cpu`) | — | — | `1.1.6-1.21.1-neoforge` | Yes (`omnicells-cpu`) | `1.1.7-26.1.2-neoforge` | No | `1.20.1 Forge`, `1.21.1 NeoForge`, `26.1.2 NeoForge` | 1.20.1/1.21.1: `>=1.1.6`; 26.1.2: `>=1.1.7` | TTC profiling and Crafting Plan display for OMNI crafting CPUs through AE2's native execution path. | [CF][omnicells-cf] / [#80](https://github.com/cTux/ae2-crafting-time/issues/80) |
...
| AEInfinityBooster (`aeinfinitybooster`; optional) | `1.20.1-1.0.0+20` | Yes (`aeinfinitybooster-terminal`) | — | — | `1.21.1-1.0.0.58` | Yes (`aeinfinitybooster-terminal`) | `26.1.2-1.0.0.57` | No | — | — | Wireless range compatibility through AE2's normal Crafting Plan; no extra TTC hook. | [CF][aeinfinity-cf] / [MR][aeinfinity-mr] / [#87](https://github.com/cTux/ae2-crafting-time/issues/87) |
