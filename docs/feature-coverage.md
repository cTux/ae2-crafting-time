...
| Optional GuideME book with an introduction and first-estimate chapter on modern NeoForge targets | [Guide book spec](guideme-guide/spec.md) and [technical design](guideme-guide/technical-design.md) |
