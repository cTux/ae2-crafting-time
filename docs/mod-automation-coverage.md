...
| MEGA Cells (optional) | `forge-2.4.6` | Yes (`megacells-cpu`) | `fabric-2.4.6` | No | `4.11.0` | No | — | — |
| OMNI Cells (optional) | `1.1.6-1.20.1-forge` | Yes (`omnicells-cpu`) | — | — | `1.1.6-1.21.1-neoforge` | No | `1.1.7-26.1.2-neoforge` | No |
