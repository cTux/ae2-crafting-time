...
| Applied Botanics (original; `appbot`; optional) | `1.5.2` | Yes (`appbot-cpu`: native mana storage + item craft) | `1.5.2` | No | `1.6.0-alpha.3` (requires unpublished Botania snapshot; not runtime-pinned) | No | — | — |
