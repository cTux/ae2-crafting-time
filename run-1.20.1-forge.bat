@echo off
set "MODS=versions\1.20.1-forge\run\mods"
set "AE2CT=ae2ct-1.20.1-1.1.1.jar"
set "AE2CT_URL=https://edge.forgecdn.net/files/7182/165/%AE2CT%"
set "JEI=jei-1.20.1-forge-15.20.0.132.jar"
set "JEI_URL=https://cdn.modrinth.com/data/u6dRKJwZ/versions/p5mYHvjx/%JEI%"
