...
if (($releaseDryRun -join "`n") -notmatch 'dry-run Modrinth dependencies: XxWD5pD3:required, a1RwDz90:optional, IiATswDj:optional, E6BFl96N:optional, udZtKfzP:optional, ArHeh5Fz:optional, anaGQD2Q:optional, 4inoel9g:optional, pNabrMMw:optional, xr109llC:optional, jjuIRIVr:optional') {
...
if (($releaseDryRun -join "`n") -notmatch 'dry-run Modrinth dependencies: XxWD5pD3:required, a1RwDz90:optional, IiATswDj:optional, rxYaglEe:optional, E6BFl96N:optional, 4inoel9g:optional, pNabrMMw:optional, xr109llC:optional, jjuIRIVr:optional') {
