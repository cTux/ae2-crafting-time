...
if ($partialOutput -notmatch 'dry-run GitHub assets: ae2-crafting-time-1\.0\.4-forge_1\.20\.1\.jar, ae2-crafting-time-1\.0\.5-fabric_1\.20\.1\.jar, ae2-crafting-time-1\.0\.4-neoforge_1\.21\.1\.jar') {
