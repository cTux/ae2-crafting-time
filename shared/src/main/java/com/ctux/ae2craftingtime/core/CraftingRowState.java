...
public final class CraftingRowState {
    private static final java.util.Set<String> BADGE_KEYS = java.util.Set.of(
            ...
            "text.ae2craftingtime.no_space", "text.ae2craftingtime.no_provider");
    ...
    public static boolean noProvider(long pending, boolean missingProvider) {
        return pending > 0 && missingProvider;
    }
}
