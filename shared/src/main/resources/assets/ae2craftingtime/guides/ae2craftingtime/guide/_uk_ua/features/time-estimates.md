...
План також показує доступну кількість і кількість до виготовлення в одному
...
щоб побачити повні кількості з підписами AE2. Вимкни **Стислі кількості
виготовлення** в **Налаштування > Клієнт > Відображення**, щоб повернути окремі
рядки AE2 в обох вікнах. Це налаштування не залежить від TTC у рядках.
