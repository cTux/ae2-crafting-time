...
public abstract class NeoEcoIntBatchDispatchMixin {
    @Redirect(method = "recordPushedPattern(Lcn/dancingsnow/neoecoae/api/me/ExecutingCraftingJob;Lcn/dancingsnow/neoecoae/impl/crafting/fastpath/ECOExtractedPatternExecution;I)V",
            at = @At(value = "INVOKE",
