...
public abstract class NeoEcoPendingDispatchMixin {
    @Redirect(method = "recordPushedPattern(Lcn/dancingsnow/neoecoae/api/me/ECOCraftingCPULogic$PendingPatternAccounting;)V",
            at = @At(value = "INVOKE",
