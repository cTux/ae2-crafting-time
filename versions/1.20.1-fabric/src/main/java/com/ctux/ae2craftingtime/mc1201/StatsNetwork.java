...
public final class StatsNetwork {
    ...
    private static FriendlyByteBuf encode(PlanStoredVariantsS2C packet) { var buffer=PacketByteBufs.create(); PlanStoredVariantsS2C.encode(packet,buffer); return buffer; }
