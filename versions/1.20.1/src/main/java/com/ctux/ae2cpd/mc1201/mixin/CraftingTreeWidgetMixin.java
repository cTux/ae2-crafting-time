...
public abstract class CraftingTreeWidgetMixin {
    ...
    @Inject(
            ...
            at = @At("RETURN"),
            require = 0)
    private void ae2cpd$drawStats(GuiGraphics guiGraphics, @Coerce Object node, CallbackInfo ci) {
        if (!Ae2CpdConfig.SHOW_IN_TREE.get()) {
            return;
        }
    ...
    @Redirect(
            ...
            require = 0)
    private void ae2cpd$appendTooltipStats(AEBaseScreen<?> screen, GuiGraphics guiGraphics, int mouseX, int mouseY,
