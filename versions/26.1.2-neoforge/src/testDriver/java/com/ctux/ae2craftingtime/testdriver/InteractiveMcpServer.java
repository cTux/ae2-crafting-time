...
public final class InteractiveMcpServer implements AutoCloseable {
        ...
        return McpServerFeatures.SyncToolSpecification.builder()
                ...
                .callHandler((exchange, request) -> {
                    try {
                        ...
                        if (response instanceof java.util.concurrent.CompletableFuture<?> pending) {
                            response = pending.get(5, java.util.concurrent.TimeUnit.SECONDS);
                        }
    ...
    private Object takeScreenshot() throws IOException {
        ...
        return DriverScreenshots.capture(minecraft, options.output().resolve(name))
                .thenApply(ignored -> Map.of("screenshot", name));
    }
